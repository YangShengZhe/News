...
import com.yangsz.news.BaseRecyclerViewAdapter;
import com.yangsz.news.Bean.MoviesBean;
import com.yangsz.news.DetailActivity;
...
public class MovieOnAdapter extends BaseRecyclerViewAdapter<MoviesBean.SubjectsBean> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.it_movie_on, parent, false);
